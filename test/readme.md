...
<a name="api-mongoose-apiuserloop"></a>
## API.user.loop
GETS health check.
...
<a name="api-mongoose-apiauthloop"></a>
## API.auth.loop
AUTH health check.
...
<a name="api-mongoose-apirecipeloop"></a>
## API.recipe.loop
CREATE One User for Recipe.
...
<a name="api-mongoose-apiingredientsloop"></a>
## API.ingredients.loop
GETS health check.
...
<a name="api-sql-apirecipesqlloop"></a>
## API.recipe.sql.loop
CREATE One User for Recipe.
...
<a name="api-sql-apiingredientssqlloop"></a>
## API.ingredients.sql.loop
GETS health check.
